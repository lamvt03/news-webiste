 ...
 <footer class="footer--section">
                ...
                <div class="col-md-3 col-xs-6 col-xxs-12 ptop--30 pbottom--30">
                    ...
                    <div class="widget">
                        ...
                        <div class="about--widget">
                            <div class="content">
                                <p>Khoa Công nghệ thông tin, Học viện Kỹ thuật mật mã.</p>
                            </div>
                            ...
                            <ul class="nav">
                                <li>
                                    <i class="fa fa-map"></i>
                                    <span>17A Cộng Hoà, phường 4, quận Tân Bình, thành phố Hồ Chí Minh.</span>
                                </li>
                                <li>
                                    <i class="fa fa-envelope-o"></i>
                                    <a href="mailto:example@example.com">votruonglam2109@gmail.com</a>
                                </li>
                                <li>
                                    <i class="fa fa-phone"></i>
                                    <a href="tel:+0886338217">(+84) 886 338 217</a>
                                </li>
                            </ul>
                        </div>
                        <!-- About Widget End -->
    ...
    <div class="footer--copyright bg--color-3">
        ...
        <div class="container">
            <p class="text float--left">&copy; 2024 phát triển bởi Vo Truong Lam<a href="#"></a></p>
